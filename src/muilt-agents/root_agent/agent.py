...
SYSTEM_INSTRUCTION = (
    ...
    "          start_time、end_time（時間格式 'YYYY-MM-DD HH:MM'）六項資訊後，\n"
    "          立刻轉派 book_agent 執行預約；缺少人數或時間時才向使用者詢問補齊\n"
    ...
    "若缺少 user_name、meeting_name、attendees、start_time 或 end_time，才主動詢問，補齊後立即執行。\n"
    "請全程使用繁體中文回覆。"
)
